...
public class AppInfo {
    ...
    public static void clearUser() {
        SPUtils.getInstance().save(UserBean.class.getSimpleName(), "");
    }

    /**
     * 保存用户信息
     */
    public static void saveUser(UserBean userInfo) {
    ...
    public static UserBean getUser() {
        UserBean userInfo = (UserBean) getCacheData(UserBean.class.getSimpleName());
        return userInfo;
    }
    ...
    public static String getCharId() {
        String result = Md5Util.getInstance().md5To32("android" + getUser().getUserId() + FileUtils.getInstance().getMyUUID() + System.currentTimeMillis());
        return result;
    }
