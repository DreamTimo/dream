package com.timo.timolib.view.navigation;
...
public class BottomBarTab extends LinearLayout {
    ...
    private boolean setImgFilter;//是否设置图片滤镜

    public void setImgFilter(boolean setImgFilter) {
        this.setImgFilter = setImgFilter;
    }
