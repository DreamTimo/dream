...
public class CustomButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColor = a.getColor(R.styleable.CustomButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.CustomButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.CustomButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.CustomButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.CustomButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.CustomButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.CustomButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.CustomButton_radius, 0);
        mRound = a.getBoolean(R.styleable.CustomButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.CustomButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.CustomButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.CustomButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.CustomButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.CustomButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.CustomButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.CustomButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.CustomButton_unableStrokeColor, 0);
        setStroke();
