package com.timo.timolib.tools.permissions;
...
import com.timo.timolib.tools.permissions.helper.PermissionHelper;
...
class RationaleDialogClickListener implements Dialog.OnClickListener {
    ...
    RationaleDialogClickListener(RationaleDialogFragmentCompat compatDialogFragment,
                                 ...
                                 PermissionUtils.RationaleCallbacks rationaleCallbacks) {
    ...
    RationaleDialogClickListener(RationaleDialogFragment dialogFragment,
                                 RationaleDialogConfig config,
                                 PermissionUtils.PermissionCallbacks callbacks,
                                 PermissionUtils.RationaleCallbacks dialogCallback) {
