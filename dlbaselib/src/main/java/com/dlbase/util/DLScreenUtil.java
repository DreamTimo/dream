...
public class DLScreenUtil {
	 ...
	 * @return
	 */
	public static Bitmap snapShotWithStatusBarFromFragment(FragmentActivity activity) {
		View view = activity.getWindow().getDecorView();
		view.setDrawingCacheEnabled(true);
		view.buildDrawingCache();
		Bitmap bmp = view.getDrawingCache();
	 ...
	 * @return
	 */
	public static Bitmap snapShotWithoutStatusBarFromFragment(FragmentActivity activity) {
		View view = activity.getWindow().getDecorView();
		view.setDrawingCacheEnabled(true);
		view.buildDrawingCache();
		Bitmap bmp = view.getDrawingCache();
