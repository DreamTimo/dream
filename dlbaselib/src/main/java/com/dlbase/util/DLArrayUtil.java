...
public class DLArrayUtil {
    ...
    /**
     * is not null and its length > 0
     * 
     * @param <V>
     * @param arrayList
     * @return
     */
    public static <V> boolean notEmpty(ArrayList<V> arrayList){
    ...
    public static <V> V getLast(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (DLObjectUtil.isEquals(value, sourceArray[i])) {
                currentPosition = i;
                break;
            }
        }
    ...
    /**
     * @see {@link DLArrayUtil#getLast(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link DLArrayUtil#getNext(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link DLArrayUtil#getLast(Object[], Object, Object, boolean)} Object is Long
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue, boolean isCircle) {
        ...
        Long[] array = DLObjectUtil.transformLongArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link DLArrayUtil#getNext(Object[], Object, Object, boolean)} Object is Long
     */
    ...
    /**
     * @see {@link DLArrayUtil#getLast(Object[], Object, Object, boolean)} Object is Integer
     */
    public static int getLast(int[] sourceArray, int value, int defaultValue, boolean isCircle) {
        ...
        Integer[] array = DLObjectUtil.transformIntArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link DLArrayUtil#getNext(Object[], Object, Object, boolean)} Object is Integer
     */
