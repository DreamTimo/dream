...
public abstract class DLVersionedGestureDetector {
	static final String LOG_TAG = "VersionedGestureDetector";
	OnGestureListener mListener;

	public static DLVersionedGestureDetector newInstance(Context context, OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		DLVersionedGestureDetector detector = null;
	...
	private static class CupcakeDetector extends DLVersionedGestureDetector {
