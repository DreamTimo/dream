...
public class DLWheelView extends View {
	...
	// Wheel Values
	private DLWheelAdapter adapter = null;
	...
	// Listeners
	private List<OnDLWheelChangedListener> changingListeners = new LinkedList<OnDLWheelChangedListener>();
	private List<OnDLWheelScrollListener> scrollingListeners = new LinkedList<OnDLWheelScrollListener>();

	/**
	 * Constructor
	 */
	public DLWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @return the adapter
	 */
	public DLWheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(DLWheelAdapter adapter) {
	 ...
	 */
	public void addChangingListener(OnDLWheelChangedListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeChangingListener(OnDLWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnDLWheelChangedListener listener : changingListeners) {
	 ...
	 * @param listener the listener 
	 */
	public void addScrollingListener(OnDLWheelScrollListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeScrollingListener(OnDLWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnDLWheelScrollListener listener : scrollingListeners) {
	...
	private int getMaxTextLength() {
		DLWheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
	...
	private void drawItems(Canvas canvas) {
		...
		Logger.getLogger(DLWheelView.class.getName()).log(Level.WARNING, ".....top....>>"+top);
		Logger.getLogger(DLWheelView.class.getName()).log(Level.WARNING, "....scrollingOffset...>>"+scrollingOffset);
