 ...
 * 
 */
public class DLScrollerNumberPicker extends View {
	/** 控件宽度 */
	...
	/** 选择的内容 */
	private ArrayList<ItemObject> itemList = new ArrayList<DLScrollerNumberPicker.ItemObject>();
	/** 设置数据 */
	...
	public DLScrollerNumberPicker(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public DLScrollerNumberPicker(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initData();
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		normalColor = attribute.getColor(
				R.styleable.NumberPicker_lib_normalTextColor, 0xff000000);
